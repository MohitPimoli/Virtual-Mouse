...
def respond(voice_data):
    ...
    # DYNAMIC CONTROLS
    elif ('launch gesture control' in voice_data) or ('launch g c' in voice_data) :
        if Gesture_Controller.GestureController.gc_mode:
    ...
    elif ('stop gesture control' in voice_data) or ('top gesture control' in voice_data):
        if Gesture_Controller.GestureController.gc_mode:
            Gesture_Controller.GestureController.gc_mode = 0
            reply('Gesture control stopped')
        else:
